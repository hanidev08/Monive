...
import { useMediaQuery } from "react-responsive"; // ✅ أضف الاستيراد
...
export const Services = () => {
  ...
  useEffect(() => {
    if (isMobile) return; // ⛔ لا تشغل الأنيميشن إذا موبايل
  ...
  }, [isMobile]); // ✅ إذا تغير حجم الشاشة، يعيد التحقق

  return (
    <div className=" mt-[200px]" id="services">
      <div className="container">
        ...
        <div className=" min-h-screen overflow-hidden" ref={sectionRef}>
          <div className=" wrapper relative h-full md:space-y-0 space-y-[50px]">
            {servicesData.map((service, i) => (
              <div
                ...
                className="item md:absolute md:inset-0 md:shadow-lg md:overflow-hidden
                "
              >
                <div className=" bg-white text-black">
                  ...
                  <div className="flex max-md:flex-col max-md:gap-5 justify-between">
                    ...
                    <div
                      className="relative w-[347px] h-[434px] max-md:w-[100vw] max-md:max-w-[1024px]
                     max-md:aspect-[4/5]
                    "
                    >
                      <Image
